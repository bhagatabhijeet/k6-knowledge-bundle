...
description: >
  ...
  the k6 binary on Mac, Windows, Linux or Docker, and setting up VS Code to write
  scripts with IntelliSense.
---
...
- [Setting Up the Editor](/k6-setup/setting-up-the-editor.md) — why k6 scripts are JavaScript (and optionally TypeScript), installing VS Code, and adding k6 IntelliSense
