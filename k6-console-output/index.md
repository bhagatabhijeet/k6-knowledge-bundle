...
description: >
  ...
  (avg, min, med, max, p90, p95), plus a simple visual guide to the math of percentiles.
---
...
- [The Math of Percentiles — Explained Simply](/k6-console-output/percentile-math.md) — a picture-first, 10th-grade-friendly guide: sorting, “how far along the line”, min/max/median/average, the walk-between-two-values trick, a three-step recipe and common traps
